...
app.post('/api/verify-otp', async (req, res) => {
  ...
  const options = {
    method: 'GET',
    hostname: 'control.msg91.com',
    path: '/api/v5/otp/verify?authkey=' + (MSG91_AUTH_KEY ? MSG91_AUTH_KEY.trim() : '') + '&mobile=' + cleanPhone + '&otp=' + otp,
    headers: { 'authkey': MSG91_AUTH_KEY ? MSG91_AUTH_KEY.trim() : '' }
  };
...
// Invite / Add Tenant API (fallback when client-side Supabase unavailable)
