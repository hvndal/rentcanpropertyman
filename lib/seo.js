...
const PAGES = [
  ...
  // Product pages — server-rendered from lib/catalog.js via lib/pages.js.
  { path: '/homes',      file: null,               indexable: true,  changefreq: 'weekly',  priority: '0.9' },
  { path: '/buildings',  file: null,               indexable: true,  changefreq: 'weekly',  priority: '0.9' },
  { path: '/commercial', file: null,               indexable: true,  changefreq: 'weekly',  priority: '0.9' },
  { path: '/airbnb',     file: null,               indexable: true,  changefreq: 'weekly',  priority: '0.9' },
  { path: '/platform',   file: null,               indexable: true,  changefreq: 'monthly', priority: '0.8' },
  { path: '/pricing',    file: null,               indexable: true,  changefreq: 'weekly',  priority: '0.9' },
