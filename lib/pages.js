...
<div class="mt-14">${R.cta('general', 'Talk to RentCan')}</div>`;
  ...
  return R.page({
    ...
    description: 'RentCan pricing — residential from ₹1,499/month, Airbnb setup from ₹9,999, full Airbnb management at 15% of booking revenue. Buildings and commercial quoted individually.',
